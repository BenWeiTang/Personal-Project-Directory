...
Sweeper is a minesweeper clone made with Unity Engine. Highlight features include [Manager class implementation](), [core gameplay implementation], [basic editor scripting](https://github.com/BenWeiTang/Sweeper/tree/Main/Assets/Scripts/Editor), and [experimental ScirptableObject-based animation system](https://github.com/BenWeiTang/Sweeper/tree/Main/Assets/Scripts/Animation).
